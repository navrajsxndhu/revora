...
interface BigInt64Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: bigint, index: number, array: BigInt64Array<TArrayBuffer>) => any, thisArg?: unknown): BigInt64Array<ArrayBuffer>;
...
interface BigUint64Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: bigint, index: number, array: BigUint64Array<TArrayBuffer>) => any, thisArg?: unknown): BigUint64Array<ArrayBuffer>;
