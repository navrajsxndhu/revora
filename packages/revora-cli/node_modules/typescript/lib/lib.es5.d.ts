...
interface ObjectConstructor {
     ...
     */
    create(o: object | null, properties: PropertyDescriptorMap & ThisType<any>): unknown;
...
interface Function {
     ...
     */
    call(this: Function, thisArg: unknown, ...argArray: unknown[]): unknown;
     ...
     */
    bind(this: Function, thisArg: unknown, ...argArray: unknown[]): unknown;
...
interface NewableFunction extends Function {
     ...
     * @param args Arguments to bind to the parameters of the function.
     */
    bind<A extends any[], B extends any[], R>(this: new (...args: [...A, ...B]) => R, thisArg: unknown, ...args: A): new (...args: B) => R;
}
...
interface String {
     ...
     */
    replace(searchValue: string | RegExp, replacer: (substring: string, ...[]) => string): string;
...
interface JSON {
     ...
     */
    stringify(value: unknown, replacer?: (this: unknown, key: string, value: unknown) => any, space?: string | number): string;
    /**
     * Converts a JavaScript value to a JavaScript Object Notation (JSON) string.
     * @param value A JavaScript value, usually an object or array, to be converted.
...
interface ReadonlyArray<T> {
     ...
     */
    filter<S extends T>(predicate: (value: T, index: number, array: readonly T[]) => value is S, thisArg?: unknown): S[];
    /**
     * Returns the elements of an array that meet the condition specified in a callback function.
     * @param predicate A function that accepts up to three arguments. The filter method calls the predicate function one time for each element in the array.
     * @param thisArg An object to which the this keyword can refer in the predicate function. If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: T, index: number, array: readonly T[]) => unknown, thisArg?: unknown): T[];
    /**
 ...
 */
type Parameters<T extends (...) => any> = T extends (...args: infer P) => any ? P : never;

/**
 * Obtain the parameters of a constructor function type in a tuple
 */
type ConstructorParameters<T extends abstract new (...) => any> = T extends abstract new (...args: infer P) => any ? P : never;

/**
 * Obtain the return type of a function type
 */
type ReturnType<T extends (...) => any> = T extends (...) => infer R ? R : unknown;

/**
 * Obtain the return type of a constructor function type
 */
type InstanceType<T extends abstract new (...) => any> = T extends abstract new (...) => infer R ? R : unknown;
...
interface Int8Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: number, index: number, array: this) => any, thisArg?: unknown): Int8Array<ArrayBuffer>;
...
interface Uint8Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: number, index: number, array: this) => any, thisArg?: unknown): Uint8Array<ArrayBuffer>;
...
interface Uint8ClampedArray<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: number, index: number, array: this) => any, thisArg?: unknown): Uint8ClampedArray<ArrayBuffer>;
...
interface Int16Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: number, index: number, array: this) => any, thisArg?: unknown): Int16Array<ArrayBuffer>;
...
interface Uint16Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: number, index: number, array: this) => any, thisArg?: unknown): Uint16Array<ArrayBuffer>;
...
interface Int32Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: number, index: number, array: this) => any, thisArg?: unknown): Int32Array<ArrayBuffer>;
...
interface Uint32Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: number, index: number, array: this) => any, thisArg?: unknown): Uint32Array<ArrayBuffer>;
...
interface Float32Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: number, index: number, array: this) => any, thisArg?: unknown): Float32Array<ArrayBuffer>;
...
interface Float64Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
     ...
     * If thisArg is omitted, undefined is used as the this value.
     */
    filter(predicate: (value: number, index: number, array: this) => any, thisArg?: unknown): Float64Array<ArrayBuffer>;
