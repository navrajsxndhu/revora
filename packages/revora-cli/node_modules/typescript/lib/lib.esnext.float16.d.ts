...
interface Float16ArrayConstructor {
     ...
     */
    from<T>(arrayLike: ArrayLike<T>, mapfn: (v: T, k: number) => number, thisArg?: unknown): Float16Array<ArrayBuffer>;
     ...
     * @param thisArg Value of 'this' used to invoke the mapfn.
     */
    from<T>(elements: Iterable<T>, mapfn?: (v: T, k: number) => number, thisArg?: unknown): Float16Array<ArrayBuffer>;
}
