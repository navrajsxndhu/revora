...
declare module "worker_threads" {
    ...
    class MessagePort implements EventTarget {
        ...
        addListener(event: string, listener: (arg: unknown) => void): this;
        ...
        off(event: "message", listener: (value: unknown) => void, options?: EventListenerOptions): this;
        off(event: "messageerror", listener: (error: Error) => void, options?: EventListenerOptions): this;
        off(event: string, listener: (arg: unknown) => void, options?: EventListenerOptions): this;
        ...
        removeListener(event: string, listener: (arg: unknown) => void, options?: EventListenerOptions): this;
    }
    ...
    class Worker extends EventEmitter {
        ...
        off(event: string | symbol, listener: (...[]) => void): this;
    }
