...
declare module "v8" {
     ...
     * @since v8.0.0
     */
    function serialize(value: unknown): NonSharedBuffer;
    /**
    ...
    type StartupSnapshotCallbackFn = () => any;
    interface StartupSnapshot {
         ...
         */
        addSerializeCallback(callback: StartupSnapshotCallbackFn, data?: unknown): void;
        /**
         ...
         * @since v18.6.0, v16.17.0
         */
        addDeserializeCallback(callback: StartupSnapshotCallbackFn, data?: unknown): void;
        /**
         ...
         * @since v18.6.0, v16.17.0
         */
        setDeserializeMainFunction(callback: StartupSnapshotCallbackFn, data?: unknown): void;
        /**
