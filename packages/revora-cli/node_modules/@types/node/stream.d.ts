...
declare module "stream" {
    ...
    type ComposeFnParam = (source: unknown) => void;
    ...
    namespace Stream {
        ...
        class Readable extends Stream implements NodeJS.ReadableStream {
             ...
             */
            map(fn: (data: unknown, options?: Pick<ArrayOptions, "signal">) => any, options?: ArrayOptions): Readable;
            /**
             ...
             */
            filter(
                fn: (data: unknown, options?: Pick<ArrayOptions, "signal">) => boolean | Promise<boolean>,
             ...
             */
            forEach(
                fn: (data: unknown, options?: Pick<ArrayOptions, "signal">) => void | Promise<void>,
                options?: ArrayOptions,
            ): Promise<void>;
            /**
             ...
             */
            find<T>(
                fn: (data: unknown, options?: Pick<ArrayOptions, "signal">) => data is T,
                options?: ArrayOptions,
            ): Promise<T | undefined>;
            find(
                fn: (data: unknown, options?: Pick<ArrayOptions, "signal">) => boolean | Promise<boolean>,
             ...
             */
            flatMap(fn: (data: unknown, options?: Pick<ArrayOptions, "signal">) => any, options?: ArrayOptions): Readable;
            /**
             ...
             */
            reduce<T = any>(
                fn: (previous: unknown, data: unknown, options?: Pick<ArrayOptions, "signal">) => T,
                initial?: undefined,
                options?: Pick<ArrayOptions, "signal">,
            ): Promise<T>;
            reduce<T = any>(
                fn: (previous: T, data: unknown, options?: Pick<ArrayOptions, "signal">) => T,
                initial: T,
                options?: Pick<ArrayOptions, "signal">,
            ): Promise<T>;
            ...
            addListener(event: "data", listener: (chunk: unknown) => void): this;
            ...
            once(event: string | symbol, listener: (...[]) => void): this;
            ...
            prependListener(event: string | symbol, listener: (...[]) => void): this;
            ...
            prependOnceListener(event: string | symbol, listener: (...[]) => void): this;
        ...
        interface TransformOptions<T extends Transform = Transform> extends DuplexOptions<T> {
            transform?:
                | ((this: T, chunk: unknown, encoding: BufferEncoding, callback: TransformCallback) => void)
                | undefined;
        ...
        type PipelineTransform<S extends PipelineTransformSource<any>, U> =
            ...
            | ((
                source: S extends (...[]) => Iterable<infer ST> | AsyncIterable<infer ST> ? AsyncIterable<ST>
                    : S,
            ) => AsyncIterable<U>);
