...
declare module "vm" {
    ...
    class Script {
         ...
         */
        runInContext(contextifiedObject: Context, options?: RunningScriptOptions): unknown;
        /**
     ...
     * @return the result of the very last statement executed in the script.
     */
    function runInContext(code: string, contextifiedObject: Context, options?: RunningCodeOptions | string): unknown;
    /**
     ...
     * @return the result of the very last statement executed in the script.
     */
    function runInThisContext(code: string, options?: RunningCodeOptions | string): unknown;
    /**
