      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Continuously measures enterprise information quality against strict completeness and accuracy standards.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Pre-ingestion</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Completeness
            ...
            <div className="text-xs text-slate-500">Required fields present</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Timeliness
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"set":"Payment Transactions","dim":"Accuracy","rule":"Must sum to Ledger Total","rate":"100%","status":"Optimal","trace":"DQG-EV-501"},{"set":"Marketing Leads","dim":"Completeness","rule":"Email field cannot be null","rate":"94%","status":"Warning","trace":"DQG-EV-502"},{"set":"Live Inventory API","dim":"Timeliness","rule":"Latency &lt; 500ms","rate":"99.9%","status":"Optimal","trace":"DQG-EV-503"}].map((row, i) => (
