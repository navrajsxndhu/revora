      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Immutable ledger recording every dataset registration, quality validation, and privacy classification change.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(129,140,248,0.05)] rounded-xl p-5">
            ...
            <div className="text-3xl font-bold text-white mb-2">1.4B</div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"id":"DF-E-9901","time":"2026-07-22T10:19:00Z","act":"AI Governance Engine","acti":"Classified Dataset as PII","gov":"Policy: Auto-Discovery","trace":"EV-DF-9901"},{"id":"DF-E-9902","time":"2026-07-22T10:18:42Z","act":"jdoe@revora","acti":"Certified Q3 Financial Dashboard","gov":"Policy: Asset Certification","trace":"EV-DF-9902"},{"id":"DF-E-9903","time":"2026-07-22T10:15:10Z","act":"Data Quality Service","acti":"Flagged completeness drop (94%)","gov":"Policy: Minimum Quality SLA","trace":"EV-DF-9903"}].map((row, i) => (
