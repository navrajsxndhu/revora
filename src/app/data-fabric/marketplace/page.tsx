      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Allows secure, governed discovery and sharing of certified datasets across the organization.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(129,140,248,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-indigo-400">Ready for consumption</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Monthly API/Report pulls</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Approval Latency
            ...
            <div className="text-xs text-slate-500">Avg request fulfillment</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Unauthorized Access
            ...
            <div className="text-xs text-slate-500">Governed delivery</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"prod":"Core User Demographics (Masked)","pub":"Data Science Team","req":"1,420 Active Subscribers","cert":"Tier 1 (Executive)","status":"Certified","trace":"EDM-EV-701"},{"prod":"Q2 Regional Sales Rollup","pub":"Finance Dept","req":"84 Downloads","cert":"Tier 2 (Internal)","status":"Certified","trace":"EDM-EV-702"},{"prod":"Raw Network Traffic Logs","pub":"Security Ops","req":"Denied (4)","cert":"None (Restricted)","status":"Restricted","trace":"EDM-EV-703"}].map((row, i) => (
