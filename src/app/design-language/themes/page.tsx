      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Universal appearance governance supporting contrast modes, executive branding, and ambient light adjustments.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-orange-900/30 bg-orange-950/10 shadow-[0_0_15px_rgba(249,115,22,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-orange-400">Active environment modes</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">User preference</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Contrast Compliance
            ...
            <div className="text-xs text-slate-500">WCAG AAA in High Contrast</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Theme Switch Time
            ...
            <div className="text-xs text-slate-500">CSS Variables mapping</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"id":"Revora Dark (Default)","cont":"8.4:1","targ":"Engineers, Analysts","eng":"Low (OLED Optimized)","state":"Active","trace":"ETS-EV-401"},{"id":"Executive Light","cont":"7.2:1","targ":"C-Suite, Daytime Ops","eng":"Medium","state":"Active","trace":"ETS-EV-402"},{"id":"High Contrast Mode","cont":"21:1","targ":"Accessibility Users","eng":"Variable","state":"Active","trace":"ETS-EV-403"}].map((row, i) => (
