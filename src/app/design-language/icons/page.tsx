      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              <Sparkle className="w-8 h-8 text-orange-500" />
              Iconography & Visual Language
            </h1>
            <p className="text-slate-400">Unified icon governance providing a universal, language-agnostic way to identify actions and status.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-orange-900/30 bg-orange-950/10 shadow-[0_0_15px_rgba(249,115,22,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-orange-400">Lucide-React integration</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-3xl font-bold text-white mb-2">2px</div>
            <div className="text-xs text-slate-500">Uniform visual weight</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Semantic Usage
            ...
            <div className="text-xs text-slate-500">Correct icon application</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Aria Labels
              <Accessibility className="w-4 h-4 text-fuchsia-500" />
            </div>
            <div className="text-3xl font-bold text-white mb-2">100%</div>
            <div className="text-xs text-slate-500">Screen reader accessible</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"name":"ShieldCheck","weight":"2px (Solid)","mean":"Verified, Secure, Governed","ctx":"Evidence Badges, Trust KPIs","status":"Adopted","trace":"IVL-EV-601"},{"name":"AlertOctagon","weight":"2px","mean":"Critical Failure, Incident","ctx":"Situation Room, High-Risk Modals","status":"Adopted","trace":"IVL-EV-602"},{"name":"ActivitySquare","weight":"2px","mean":"Telemetry, Live Data","ctx":"Performance Dashboards, Logs","status":"Adopted","trace":"IVL-EV-603"}].map((row, i) => (
