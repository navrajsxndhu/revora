      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Executive intelligence demonstrating the ROI and adoption of the enterprise design language.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-orange-900/30 bg-orange-950/10 shadow-[0_0_15px_rgba(249,115,22,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-orange-400">Saved engineering hours</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-3xl font-bold text-white mb-2">Near Zero</div>
            <div className="text-xs text-slate-500">Hardcoded styles removed</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Component Reuse
            ...
            <div className="text-xs text-slate-500">Platform efficiency</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Codebase Shrink
            ...
            <div className="text-xs text-slate-500">Removed custom CSS</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"ass":"PremiumTable (v2.4)","imp":"14.2M","adopt":"100% of Grids","orph":"0 Legacy Tables","health":"Optimal","trace":"DAN-EV-801"},{"ass":"Design Tokens (Color)","imp":"1.4B","adopt":"99.8% of UI","orph":"14 hex codes (Tech Debt)","health":"Optimal","trace":"DAN-EV-802"},{"ass":"Executive Modal","imp":"412K","adopt":"100% of Approvals","orph":"0 Custom Overlays","health":"Optimal","trace":"DAN-EV-803"}].map((row, i) => (
