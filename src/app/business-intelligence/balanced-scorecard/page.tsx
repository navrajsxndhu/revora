      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Measures organizational performance across Financial, Customer, Process, and Growth dimensions.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(129,140,248,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-indigo-400">Holistic performance</div>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">NPS & Retention</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Internal Process
            ...
            <div className="text-3xl font-bold text-white mb-2">88/100</div>
            <div className="text-xs text-slate-500">Operational drag</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"per":"Financial","ind":"Gross Margin","cur":"78.4%","tar":"80.0%","status":"Warning","trace":"BSC-EV-501"},{"per":"Customer","ind":"Net Promoter Score","cur":"64","tar":"60","status":"Optimal","trace":"BSC-EV-502"},{"per":"Internal Process","ind":"Deployment Frequency","cur":"14/day","tar":"10/day","status":"Optimal","trace":"BSC-EV-503"}].map((row, i) => (
