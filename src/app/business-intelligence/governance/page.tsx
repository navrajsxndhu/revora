      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Constitutional governance ensuring executive reporting remains trusted, standardized, and evidence-based.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(129,140,248,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-indigo-400">Board approved</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Unsanctioned dashboards</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
            ...
            <div className="text-3xl font-bold text-white mb-2">0</div>
            <div className="text-xs text-slate-500">Unified terminology</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
            ...
            <div className="text-xs text-slate-500">Strict compliance</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"pol":"No unofficial Revenue metrics","dom":"Finance / Sales","enf":"Must use Master Data","block":"14","gov":"Verified","trace":"BGB-EV-801"},{"pol":"Board Reports require C-Level signoff","dom":"Executive Comms","enf":"Approval Workflow","block":"2","gov":"Verified","trace":"BGB-EV-802"},{"pol":"Forecasts must publish confidence %","dom":"Data Science","enf":"Metadata requirement","block":"42","gov":"Verified","trace":"BGB-EV-803"}].map((row, i) => (
