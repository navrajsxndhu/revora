      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Transforms historical performance into predictive insight for proactive executive decision making.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(129,140,248,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-indigo-400">Rolling 12 months</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">AI-driven predictions</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Revenue Variance
            ...
            <div className="text-xs text-slate-500">Actual vs Forecast</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Risk Flags
            ...
            <div className="text-xs text-slate-500">Predicted anomalies</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"mod":"Q4 Revenue Trajectory","targ":"Net New ARR","cur":"$14.2M","next":"$18.4M (Expected)","conf":"High","trace":"FTI-EV-401"},{"mod":"Customer Churn Predictor","targ":"Logo Churn Rate","cur":"2.1%","next":"2.4% (Risk Warning)","conf":"Medium","trace":"FTI-EV-402"},{"mod":"Infrastructure Capacity","targ":"Compute Spend","cur":"$412K/mo","next":"$540K/mo","conf":"High","trace":"FTI-EV-403"}].map((row, i) => (
