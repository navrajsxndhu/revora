      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Split View & Comparison Studio
            </h1>
            <p className="text-slate-400">Allows side-by-side constitutional comparison of policies, architectures, and incident timelines.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(129,140,248,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-indigo-400">Concurrent diffs</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Cryptographic hash compare</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Time Saved
            ...
            <div className="text-xs text-slate-500">Per complex review</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
            ...
            <div className="text-xs text-slate-500">Governed primitives</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"targ":"Firewall Policy (SOC2)","left":"v1.1.4 (Prod)","right":"v1.1.5 (Staging)","diff":"2 Rule Modifications","gov":"Verified","trace":"SVS-EV-401"},{"targ":"Kubernetes Blueprint","left":"Template v4","right":"Template v5","diff":"Added Resource Limits","gov":"Verified","trace":"SVS-EV-402"},{"targ":"Vendor Contract","left":"AWS Master Ag.","right":"GCP Master Ag.","diff":"Liability Clauses","gov":"Verified","trace":"SVS-EV-403"}].map((row, i) => (
