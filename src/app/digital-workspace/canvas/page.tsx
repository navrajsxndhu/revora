      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Workspace Canvas Manager
            </h1>
            <p className="text-slate-400">Governs the spatial organization of enterprise components, creating movable, resizable dashboards.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(129,140,248,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-indigo-400">Custom layouts</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Snap-to-grid active</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Accessibility
            ...
            <div className="text-xs text-slate-500">Keyboard navigatable</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Canvas Size
            ...
            <div className="text-3xl font-bold text-white mb-2">Infinite</div>
            <div className="text-xs text-slate-500">Zoom & Pan supported</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"inst":"Executive Command Board","dom":"Cross-Enterprise","wid":"14 Active Widgets","zoom":"100% (Default)","status":"Active","trace":"WCM-EV-501"},{"inst":"Incident War Room","dom":"Security / DevOps","wid":"8 Active Widgets","zoom":"120% (Focus)","status":"Active","trace":"WCM-EV-502"},{"inst":"Quarterly Planning","dom":"Finance / HR","wid":"4 Active Widgets","zoom":"80% (Overview)","status":"Suspended","trace":"WCM-EV-503"}].map((row, i) => (
