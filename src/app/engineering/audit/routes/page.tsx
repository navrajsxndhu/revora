...
import { ArrowLeft, Layout, Search, ShieldCheck, Activity, Target, Download, Settings, History, Database, Network, Key, Layout, Code2, Cpu, LineChart, FileCode, CheckCircle2, AlertTriangle, Zap, Server } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Governance for Next.js routing architecture, ensuring metadata completeness and consistency.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-emerald-900/30 bg-emerald-950/10 shadow-[0_0_15px_rgba(16,185,129,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Active application routes</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">100% Layout coverage</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Metadata Score
            ...
            <div className="text-xs text-emerald-400">SEO & Social tags</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Broken Links
            ...
            <div className="text-xs text-slate-500">Internal navigation drift</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"path":"/engineering/audit","check":"Valid Layout & Page","cmd":"Registered","meta":"Complete","status":"Passed","trace":"RT-EV-501"},{"path":"/legacy-dashboard","check":"Orphaned Route","cmd":"Unregistered","meta":"Missing Title","status":"Critical","trace":"RT-EV-502"},{"path":"/api/v1/health","check":"API Route Valid","cmd":"N/A","meta":"N/A","status":"Passed","trace":"RT-EV-503"}].map((row, i) => (
