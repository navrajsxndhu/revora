...
import { ArrowLeft, LineChart, Search, ShieldCheck, Activity, Target, Download, Settings, History, Database, Network, Key, Layout, Code2, Cpu, FileCode, CheckCircle2, AlertTriangle, Zap, Server, TrendingDown } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Executive engineering intelligence. Visualizes technical debt trends and engineering velocity.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-emerald-900/30 bg-emerald-950/10 shadow-[0_0_15px_rgba(16,185,129,0.05)] rounded-xl p-5">
            ...
            <div className="text-3xl font-bold text-white mb-2">97.4</div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Reduction this quarter</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Build Stability
            ...
            <div className="text-xs text-slate-500">CI/CD Success Rate</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Velocity
            ...
            <div className="text-xs text-slate-500">Deployment frequency</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"cat":"Test Coverage","cur":"92.4%","prev":"91.8%","trend":"+0.6%","status":"Passed","trace":"AN-EV-101"},{"cat":"Component Modularity","cur":"88%","prev":"82%","trend":"+6.0%","status":"Passed","trace":"AN-EV-102"},{"cat":"Mean Time to Recovery","cur":"14m","prev":"22m","trend":"-8m","status":"Passed","trace":"AN-EV-103"},{"cat":"Open Tech Debt Issues","cur":"24","prev":"18","trend":"+6","status":"Warning","trace":"AN-EV-104"}].map((row, i) => (
