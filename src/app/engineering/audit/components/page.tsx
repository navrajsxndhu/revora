...
import { ArrowLeft, Box, Search, ShieldCheck, Activity, Target, Download, Settings, History, Database, Network, Key, Layout, Code2, Cpu, LineChart, FileCode, CheckCircle2, AlertTriangle, Zap, Server } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Executive visibility into UI consistency, Tailwind compliance, and Premium component adoption.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-emerald-900/30 bg-emerald-950/10 shadow-[0_0_15px_rgba(16,185,129,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">High modularity score</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Zero inline styles</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Premium Adoption
            ...
            <div className="text-xs text-purple-400">Enterprise UI standard</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              A11y Score
            ...
            <div className="text-xs text-slate-500">Accessibility rating</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"name":"PremiumTable","cat":"Data Display","usage":"142","design":"100% Compliant","status":"Passed","trace":"UI-EV-601"},{"name":"EvidenceBadge","cat":"Governance","usage":"380","design":"100% Compliant","status":"Passed","trace":"UI-EV-602"},{"name":"LegacyCard","cat":"Container","usage":"12","design":"Missing Dark Mode","status":"Warning","trace":"UI-EV-603"}].map((row, i) => (
