      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Unified Enterprise Timeline
            </h1>
            <p className="text-slate-400">A chronological operational story of the organization spanning all constitutional actions.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-fuchsia-900/30 bg-fuchsia-950/10 shadow-[0_0_15px_rgba(217,70,239,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-fuchsia-400">Constitutional actions logged</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Cross-module linking</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Audit Velocity
            ...
            <div className="text-xs text-slate-500">Average query time</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Missing Evidence
            ...
            <div className="text-xs text-slate-500">Perfect cryptographic seal</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"time":"10:42 AM Today","ctx":"Production Deployment (Frontend)","init":"Release Engineering","imp":"High (Customer Facing)","status":"Completed","trace":"UET-EV-101"},{"time":"09:15 AM Today","ctx":"Financial Ledger Reconciliation","init":"Automated Job","imp":"Critical (Compliance)","status":"Failed","trace":"UET-EV-102"},{"time":"08:00 AM Today","ctx":"C-Suite Access Granted","init":"System Admin","imp":"Medium (RBAC)","status":"Approved","trace":"UET-EV-103"}].map((row, i) => (
