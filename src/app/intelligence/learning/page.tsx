...
import { ArrowLeft, Search, ShieldCheck, Activity, Target, Download, Settings, History, BrainCircuit, Layers, Eye, Smile, Move, Languages, Accessibility, Briefcase, Lock, LineChart, CheckCircle2, AlertTriangle, XCircle, ArrowRight, Image, Keyboard, Timer, TrendingUp, TrendingDown, BookOpen, MousePointerClick, Database, Users, FileCode, GraduationCap, Sparkles, Link as LinkIcon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Contextually adapts to the users experience to provide continuous workflow education.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Adaptive learning state</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Undiscovered capabilities</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Onboarding
            ...
            <div className="text-xs text-slate-500">Core modules complete</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Time Saved
            ...
            <div className="text-3xl font-bold text-white mb-2">14h</div>
            <div className="text-xs text-slate-500">Through workflow tips</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"mod":"Advanced Command Palette","ctx":"User clicks navigation frequently","time":"2 mins","prop":"Navigate 4x faster","status":"Pending","trace":"LRN-EV-701"},{"mod":"Automating Approvals","ctx":"User approves 10+ identical requests","time":"5 mins","prop":"Save 2 hours/week","status":"Pending","trace":"LRN-EV-702"},{"mod":"Intro to RXOS","ctx":"First login to Experience Command Center","time":"Completed","prop":"Understand UX Governance","status":"Passed","trace":"LRN-EV-703"}].map((row, i) => (
