...
import { ArrowLeft, Search, ShieldCheck, Activity, Target, Download, Settings, History, BrainCircuit, Layers, Eye, Smile, Move, Languages, Accessibility, Briefcase, Lock, LineChart, CheckCircle2, AlertTriangle, XCircle, ArrowRight, Image, Keyboard, Timer, TrendingUp, TrendingDown, BookOpen, MousePointerClick, Database, Users, FileCode, BarChart2, HeartHandshake, Link as LinkIcon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Measures the enterprise effectiveness of AI-driven recommendations and user trust.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Overall RIOS Effectiveness</div>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Faster approvals</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              User Trust
            ...
            <div className="text-xs text-slate-500">Survey metrics</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"met":"Guidance Acceptance Rate","cur":"88%","prev":"74%","impact":"Higher compliance adherence","status":"Passed","trace":"INA-EV-901"},{"met":"Average Decision Time","cur":"45s","prev":"1m 20s","impact":"Reduced operational drag","status":"Passed","trace":"INA-EV-902"},{"met":"Ignored Recommendations","cur":"12%","prev":"26%","impact":"Needs context tuning","status":"Warning","trace":"INA-EV-903"}].map((row, i) => (
