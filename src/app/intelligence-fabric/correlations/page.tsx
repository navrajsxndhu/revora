      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Automatically discovers meaningful enterprise relationships without manual intervention.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-teal-900/30 bg-teal-950/10 shadow-[0_0_15px_rgba(20,184,166,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-teal-400">In last 30 days</div>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Fully autonomous mapping</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Cross-Department
            ...
            <div className="text-xs text-slate-500">Silos eliminated</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"trig":"CPU Spike (Infrastructure)","corr":"End-of-Month Financial Batch","conf":"99.8%","act":"Auto-scaled cluster","status":"Optimal","trace":"CDE-EV-201"},{"trig":"Failed Security Audit","corr":"New Marketplace Extension","conf":"94.2%","act":"Quarantined Plugin","status":"Warning","trace":"CDE-EV-202"},{"trig":"High Attrition (HR)","corr":"Elevated On-Call Pages (Eng)","conf":"88.4%","act":"Alerted VP Engineering","status":"Critical","trace":"CDE-EV-203"}].map((row, i) => (
