      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Enterprise Automation Registry
            </h1>
            <p className="text-slate-400">The immutable inventory of every active automation policy and workflow executing in the enterprise.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(129,140,248,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-indigo-400">Active in production</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-3xl font-bold text-white mb-2">11,776</div>
            <div className="text-xs text-slate-500">Across all workflows</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Risk Ratings
            ...
            <div className="text-3xl font-bold text-white mb-2">Calculated</div>
            <div className="text-xs text-slate-500">Continuous scoring</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Orphaned Workflows
            ...
            <div className="text-xs text-slate-500">Strict ownership</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"id":"WF-SEC-099","own":"Security Office","risk":"Critical","freq":"Daily","state":"Active","trace":"EAR-EV-901"},{"id":"WF-HR-042","own":"HR Operations","risk":"Medium","freq":"Hourly","state":"Active","trace":"EAR-EV-902"},{"id":"WF-FIN-014","own":"Finance Dept","risk":"High","freq":"Monthly","state":"Active","trace":"EAR-EV-903"}].map((row, i) => (
