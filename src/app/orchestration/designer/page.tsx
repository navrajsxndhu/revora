      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">A drag-and-drop constitutional workflow builder that models human approvals, policy checks, and execution paths.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Per workflow</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Validation Rate
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Derived from library</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"wf":"Incident Escalation T1->T2","dept":"Security Ops","comp":"Medium (6 nodes)","human":"Required (SOC Lead)","state":"Active","trace":"DES-EV-101"},{"wf":"Vendor Marketplace Onboarding","dept":"Procurement","comp":"High (14 nodes)","human":"Required (Legal, CISO)","state":"Draft","trace":"DES-EV-102"},{"wf":"Automated IAM De-provisioning","dept":"IT","comp":"Low (3 nodes)","human":"Required (Manager)","state":"Active","trace":"DES-EV-103"}].map((row, i) => (
