      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Encourages platform confidence through professional mastery milestones.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Organization average</div>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Mastered all workflows</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Engagement Score
            ...
            <div className="text-xs text-slate-500">Executive rating</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"title":"Governance Guardian","cat":"Compliance","crit":"100 Policies Audited","users":"42","level":"Expert","trace":"PAC-EV-701"},{"title":"Keyboard Warrior","cat":"Productivity","crit":"Used Cmd Palette 500x","users":"142","level":"Expert","trace":"PAC-EV-702"},{"title":"First Steps","cat":"Onboarding","crit":"Completed Initial Setup","users":"1,492","level":"Novice","trace":"PAC-EV-703"}].map((row, i) => (
