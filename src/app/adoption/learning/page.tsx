      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Inline explanations, tutorials, and smart tooltips triggered exactly when needed.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Tooltips & inline hints viewed</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Shifted to inline learning</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Concept Retention
            ...
            <div className="text-xs text-slate-500">Repeat mistakes prevented</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Active Tutorials
            ...
            <div className="text-xs text-slate-500">Embedded across platform</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"ctx":"Command Palette","trig":"User clicks navigation 5x","type":"Interactive Hint","rat":"4.8/5","eng":"High","trace":"CLE-EV-301"},{"ctx":"Evidence Ledger","trig":"First time viewing trace","type":"Inline Explanation","rat":"4.9/5","eng":"High","trace":"CLE-EV-302"},{"ctx":"Data Retention Policy","trig":"Hover over Warning","type":"Smart Tooltip","rat":"4.2/5","eng":"Medium","trace":"CLE-EV-303"}].map((row, i) => (
