      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Constitutional governance ensuring all educational content aligns with enterprise standards.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Verified by Governance</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Tutorials awaiting sign-off</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Approved Guides
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Speed of approval</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"cont":"Architecture Capability Tutorial","mod":"Enterprise Architecture","sub":"UX Team","rev":"Sarah Jenkins","status":"Approved","trace":"ARB-EV-901"},{"cont":"Security Exemption Guide","mod":"Trust Governance","sub":"Security Ops","rev":"Pending","status":"Pending Review","trace":"ARB-EV-902"},{"cont":"Legacy DB Migration Hint","mod":"Infrastructure","sub":"DevOps","rev":"Marcus Chen","status":"Rejected","trace":"ARB-EV-903"}].map((row, i) => (
