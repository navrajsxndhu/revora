      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Productivity Insights Center
            </h1>
            <p className="text-slate-400">Analyzes navigation efficiency, providing users with actionable metrics on their own workflow.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Personalized tips</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Users changed behavior</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Avg Time Saved
            ...
            <div className="text-3xl font-bold text-white mb-2">14m / day</div>
            <div className="text-xs text-slate-500">Per user efficiency</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Context Switches
            ...
            <div className="text-xs text-slate-500">Reduced workflow jumps</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"cat":"Navigation","rec":"Pin \"Approvals\" to Sidebar","ineff":"Searching for approvals daily","adopt":"68%","status":"Optimal","trace":"PIC-EV-601"},{"cat":"Meeting Habits","rec":"Enable Auto-Decline under Focus","ineff":"Context switching during coding","adopt":"41%","status":"Optimal","trace":"PIC-EV-602"},{"cat":"Search","rec":"Use \"is:open\" shortcut","ineff":"Manual filtering tickets","adopt":"22%","status":"Warning","trace":"PIC-EV-603"}].map((row, i) => (
