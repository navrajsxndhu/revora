      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Tracks the composition and usage of modular UI components while enforcing core governance.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Daily widget interactions</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-3xl font-bold text-white mb-2">6.4</div>
            <div className="text-xs text-slate-500">Cognitive load check</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Locked Core Widgets
            ...
            <div className="text-xs text-slate-500">Governance preserved</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Hidden (Unused)
            ...
            <div className="text-xs text-slate-500">Clutter reduction</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"wid":"Pending Approvals","cat":"Workflow","eng":"High","req":"Mandatory (Managers)","status":"Optimal","trace":"SWM-EV-201"},{"wid":"System Health Status","cat":"Observability","eng":"Medium","req":"Optional","status":"Optimal","trace":"SWM-EV-202"},{"wid":"Team Birthdays","cat":"Social","eng":"Low","req":"Optional","status":"Warning","trace":"SWM-EV-203"}].map((row, i) => (
