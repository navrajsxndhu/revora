      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Immutable cryptographic trails for all significant discovery and search governance operations.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Permissions verified</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Ledger Integrity
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Suspicious search behavior</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"id":"SRC-E-8044","time":"2026-07-22T08:14:00Z","actor":"Sarah Jenkins","act":"Saved Collection: SOC2","gov":"Policy: Collab-Auth","trace":"EV-S-8044"},{"id":"SRC-E-8043","time":"2026-07-22T08:12:15Z","actor":"Automated Agent","act":"Re-indexed HR Policies","gov":"Policy: Mask-PII","trace":"EV-S-8043"},{"id":"SRC-E-8042","time":"2026-07-22T08:05:00Z","actor":"Marcus Chen","act":"Searched \"Staging DB Password\"","gov":"Blocked (RBAC/Policy)","trace":"EV-S-8042"}].map((row, i) => (
