      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Constitutional oversight managing search indices, exemptions, and sensitive knowledge visibility.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Zero data leakage</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Search restriction rules</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Pending Exemptions
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-3xl font-bold text-white mb-2">Passed</div>
            <div className="text-xs text-slate-500">Daily cryptographic check</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"pol":"Executive Salary Masking","target":"HR Records","rest":"Exclude from Index","auth":"VP HR","status":"Approved","trace":"SGB-EV-901"},{"pol":"M&A Project Sandbox","target":"Project \"Titan\"","rest":"Strict RBAC Whitelist","auth":"Legal Board","status":"Approved","trace":"SGB-EV-902"},{"pol":"Log PII Sanitization","target":"App Logs","rest":"Regex Redaction","auth":"Security Team","status":"Review Required","trace":"SGB-EV-903"}].map((row, i) => (
