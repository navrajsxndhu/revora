      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Executive intelligence demonstrating the ROI of a seamless multi-device workforce strategy.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(99,102,241,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-indigo-400">Seamless workflow score</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Est. productivity gain</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Avg Devices/User
            ...
            <div className="text-xs text-slate-500">Enterprise ecosystem</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Handoff Delays
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"dept":"Executive Ops","mob":"94%","tab":"88%","trans":"14.2","status":"Optimal","trace":"CAN-EV-801"},{"dept":"Field Engineering","mob":"100%","tab":"100%","trans":"22.4","status":"Optimal","trace":"CAN-EV-802"},{"dept":"Finance Analytics","mob":"12%","tab":"4%","trans":"1.2","status":"Warning","trace":"CAN-EV-803"}].map((row, i) => (
