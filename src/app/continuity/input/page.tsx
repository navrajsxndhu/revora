      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Universal Input Experience
            </h1>
            <p className="text-slate-400">Standardizes enterprise interactions across keyboard, mouse, touch, trackpad, and voice modalities.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(99,102,241,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-indigo-400">Supported interaction types</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Keyboard power users</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              A11y Controllers
            ...
            <div className="text-xs text-slate-500">Assistive devices active</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Error Rate
            ...
            <div className="text-xs text-slate-500">Misclicks/Mis-taps</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"task":"Bulk Approvals","prim":"Keyboard (Cmd+Enter)","fall":"Voice Command","time":"0.8s","gov":"Verified","trace":"UIE-EV-701"},{"task":"Architecture Drawing","prim":"Stylus","fall":"Trackpad Grid","time":"N/A","gov":"Verified","trace":"UIE-EV-702"},{"task":"Audit Review","prim":"Touch Swipe","fall":"Arrow Keys","time":"1.2s","gov":"Verified","trace":"UIE-EV-703"}].map((row, i) => (
