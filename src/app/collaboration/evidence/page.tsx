      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Collaboration Evidence Ledger
            </h1>
            <p className="text-slate-400">Cryptographic auditing for every cross-functional decision, message interaction, and broadcast.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Immutable records</div>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Legal/Compliance searches</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Data Retention
            ...
            <div className="text-xs text-slate-500">Policy compliance</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"id":"COL-E-9042","time":"2026-07-22T08:14:00Z","actor":"Sarah Jenkins","act":"Approved Decision: GraphQL","impact":"Architecture Strategy","trace":"EV-C-9042"},{"id":"COL-E-9041","time":"2026-07-22T08:12:15Z","actor":"CISO Office","act":"Sent Enterprise Broadcast","impact":"Mandatory Policy Ack","trace":"EV-C-9041"},{"id":"COL-E-9040","time":"2026-07-22T08:05:00Z","actor":"Contractor","act":"Attempted to share Prod DB","impact":"Blocked (Zero-Trust)","trace":"EV-C-9040"}].map((row, i) => (
