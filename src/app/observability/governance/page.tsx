      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Observability Governance Board
            </h1>
            <p className="text-slate-400">Constitutional oversight enforcing strict monitoring standards, SLO adherence, and on-call policies.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">All Tier 1 mapped</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Deployment Blocks
            ...
            <div className="text-xs text-slate-500">Missing telemetry</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Audit Readiness
            ...
            <div className="text-xs text-slate-500">Evidence backed</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"rule":"All Tier 0 services require Tracing","dom":"Core Architecture","enf":"CI/CD Block","block":"142","gov":"Verified","trace":"OGB-EV-801"},{"rule":"Deployments freeze if Error Budget < 0","dom":"Release Engineering","enf":"Pipeline Reject","block":"12","gov":"Verified","trace":"OGB-EV-802"},{"rule":"P1 incidents require post-mortem within 48h","dom":"SRE Operations","enf":"Manager Escalation","block":"0 (Compliant)","gov":"Verified","trace":"OGB-EV-803"}].map((row, i) => (
