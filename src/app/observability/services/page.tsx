      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">The operational inventory mapping availability, latency, and error rates to direct business impact.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(129,140,248,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-indigo-400">Rolling 30 days</div>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Across core paths</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Services Mapped
            ...
            <div className="text-xs text-slate-500">Fully observable</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"srv":"Authentication Core","tier":"Tier 0","avail":"100.00%","lat":"42ms","health":"Healthy","trace":"ESH-EV-201"},{"srv":"Checkout Processing","tier":"Tier 1","avail":"99.92%","lat":"1.2s","health":"Degraded","trace":"ESH-EV-202"},{"srv":"Legacy Reporting DB","tier":"Tier 3","avail":"84.2%","lat":"14s","health":"Failed","trace":"ESH-EV-203"}].map((row, i) => (
