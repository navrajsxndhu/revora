      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Visualizes real-time architectural dependencies to trace cascading failures across the enterprise ecosystem.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(129,140,248,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-indigo-400">Service connections</div>
          </div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Zero redundancy</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              External APIs
            ...
            <div className="text-xs text-slate-500">3rd party reliance</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"org":"Checkout Service","targ":"Stripe API Gateway","type":"Synchronous REST","imp":"Tier 0 (Revenue Block)","state":"Active","trace":"ODM-EV-601"},{"org":"User Profile Load","targ":"Redis Cache Cluster","type":"Asynchronous PubSub","imp":"Tier 2 (Latency Spikes)","state":"Active","trace":"ODM-EV-602"},{"org":"Reporting Engine","targ":"Legacy DB (Deprecating)","type":"Batch Query","imp":"Tier 3 (Delayed Reports)","state":"Warning","trace":"ODM-EV-603"}].map((row, i) => (
