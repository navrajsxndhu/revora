      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Immutable ledger recording every incident escalation, SLO breach, and resilience simulation event.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-indigo-900/30 bg-indigo-950/10 shadow-[0_0_15px_rgba(129,140,248,0.05)] rounded-xl p-5">
            ...
            <div className="text-3xl font-bold text-white mb-2">412M</div>
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Post-mortem signatures</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"id":"OB-E-9901","time":"2026-07-22T10:22:00Z","act":"Reliability Engine","acti":"Froze Deployment (Error Budget)","gov":"Policy: SLO Adherence","trace":"EV-OB-9901"},{"id":"OB-E-9902","time":"2026-07-22T10:20:42Z","act":"jdoe (Incident Commander)","acti":"Elevated incident to SEV-1","gov":"Policy: Escalation Procedures","trace":"EV-OB-9902"},{"id":"OB-E-9903","time":"2026-07-22T10:18:10Z","act":"Resilience Simulator","acti":"Completed Region Failover Test","gov":"Policy: DR Compliance","trace":"EV-OB-9903"}].map((row, i) => (
