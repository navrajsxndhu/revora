      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Deconstructing complex governance decisions into plain, understandable language.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Auto-generated context</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Zero black-box errors</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              User Clarifications
            ...
            <div className="text-xs text-slate-500">Reduction in help tickets</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Avg Readability
            ...
            <div className="text-3xl font-bold text-white mb-2">8th Grade</div>
            <div className="text-xs text-slate-500">Plain language score</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"act":"Production DB Access","exp":"Requires Platform Admin role to execute.","pol":"PRD-021 (Zero Trust)","rem":"Request Temp Access","status":"Denied","trace":"EDC-EV-101"},{"act":"Push to Main Branch","exp":"Failed CI/CD Quality Gate (Lint).","pol":"ENG-114 (Quality)","rem":"Fix Code & Retry","status":"Denied","trace":"EDC-EV-102"},{"act":"Expense Approval","exp":"Amount exceeds L1 clearance limit.","pol":"FIN-042 (Spend Limit)","rem":"Escalated to VP","status":"Pending","trace":"EDC-EV-103"}].map((row, i) => (
