      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Enterprise Confidence Simulator
            </h1>
            <p className="text-slate-400">Predictive modeling to visualize how policy changes affect organizational trust and friction.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Pre-deployment checks</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Blocked workflows saved</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Accuracy
            ...
            <div className="text-xs text-slate-500">Simulation vs Reality</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Active Drafts
            ...
            <div className="text-xs text-slate-500">Proposed governance changes</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"change":"Enforce MFA on Intranet","imp":"High Initial Friction","users":"2,400","trust":"Neutral","status":"Pending","trace":"ECS-EV-901"},{"change":"Revoke standing DB access","imp":"Moderate (SRE Team)","users":"45","trust":"Positive (Secure)","status":"Approved","trace":"ECS-EV-902"},{"change":"Simplify Expense Policy","imp":"Massive Friction Drop","users":"1,200","trust":"Highly Positive","status":"Approved","trace":"ECS-EV-903"}].map((row, i) => (
