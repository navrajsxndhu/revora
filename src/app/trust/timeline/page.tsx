      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">A chronological, narrative explanation of enterprise permission and security events.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Security actions logged</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Machine to human text</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Anomaly Detects
            ...
            <div className="text-xs text-slate-500">Suspicious timelines</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Audit Readiness
            ...
            <div className="text-xs text-slate-500">Time to generate report</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"time":"10:14 AM","actor":"Sarah Jenkins","expl":"Granted temp production access by Admin (INC-801).","risk":"Low","gov":"Verified","trace":"SAT-EV-501"},{"time":"09:42 AM","actor":"System Worker","expl":"Automatically rotated database credentials.","risk":"Low","gov":"Verified","trace":"SAT-EV-502"},{"time":"08:15 AM","actor":"Unknown IP","expl":"Failed login attempt. Blocked by Geo-Fence.","risk":"High","gov":"Verified","trace":"SAT-EV-503"}].map((row, i) => (
