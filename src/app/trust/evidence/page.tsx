      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">The cryptographic anchor backing every security explanation and transparency claim.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Immutable explanations</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Zero tampering</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Read Latency
            ...
            <div className="text-xs text-slate-500">Instant evidence retrieval</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Auditor Queries
            ...
            <div className="text-xs text-slate-500">External verification</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"id":"TRU-E-1104","time":"2026-07-22T09:14:00Z","act":"Explained PRD-021 Denial","hash":"0x8f4...b2a","gov":"Policy: Clear Denials","trace":"EV-T-1104"},{"id":"TRU-E-1103","time":"2026-07-22T09:12:15Z","act":"Generated Narrative Timeline","hash":"0x1c9...d4f","gov":"Policy: Audit Logging","trace":"EV-T-1103"},{"id":"TRU-E-1102","time":"2026-07-22T09:05:00Z","act":"Simulated MFA Rollout","hash":"0x4a2...e1b","gov":"Policy: Zero Friction","trace":"EV-T-1102"}].map((row, i) => (
