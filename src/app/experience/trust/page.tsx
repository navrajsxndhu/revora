      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Ensures every system decision is understandable and nothing is mysterious.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Full transparency</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Zero mysterious events</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Evidence Traces
            ...
            <div className="text-xs text-slate-500">Immutable records linked</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Policy Links
            ...
            <div className="text-3xl font-bold text-white mb-2">100%</div>
            <div className="text-xs text-slate-500">Every action cites a rule</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"dec":"Access Denied","ctx":"User lacks Admin Role","app":"System RBAC","pol":"Security Protocol Alpha","status":"Compliant","trace":"TRU-EV-801"},{"dec":"Deployment Blocked","ctx":"Test coverage dropped 2%","app":"CI/CD Pipeline","pol":"Quality Standard V2","status":"Compliant","trace":"TRU-EV-802"},{"dec":"Data Retention Cleared","ctx":"90-day automated purge","app":"Compliance Engine","pol":"GDPR Article 17","status":"Compliant","trace":"TRU-EV-803"}].map((row, i) => (
