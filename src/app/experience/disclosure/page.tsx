      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Progressive Disclosure Governance
            </h1>
            <p className="text-slate-400">Validates dashboard complexity and context-aware navigation flows.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">No overwhelming screens</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Drill-down depth &gt; 2</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
            ...
            <div className="text-xs text-slate-500">Requires simplification</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Focus Score
            ...
            <div className="text-xs text-slate-500">Action-to-Data Ratio</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"ctx":"Security Audit Center","dense":"Low","depth":"1 Click","aware":"Yes","status":"Passed","trace":"DIS-EV-201"},{"ctx":"Performance Metrics","dense":"Medium","depth":"2 Clicks","aware":"Yes","status":"Passed","trace":"DIS-EV-202"},{"ctx":"User Access Policies","dense":"High","depth":"4 Clicks","aware":"No","status":"Warning","trace":"DIS-EV-203"}].map((row, i) => (
