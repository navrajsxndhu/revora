...
import { ArrowLeft, Search, ShieldCheck, Activity, Target, Download, Settings, History, BrainCircuit, Layers, Eye, Smile, Move, Languages, Accessibility, Briefcase, Lock, LineChart, CheckCircle2, AlertTriangle, XCircle, ArrowRight, Image, Keyboard, Timer, TrendingUp, TrendingDown, BookOpen, MousePointerClick, Database, Users, FileCode, LayoutTemplate, Link as LinkIcon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Constitutional standards for 10-second executive comprehension.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-3xl font-bold text-white mb-2">&lt; 8s</div>
            <div className="text-xs text-cyan-400">Avg time to understand state</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">7-part layout adhered</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              KPI Prominence
            ...
            <div className="text-xs text-slate-500">Top-level visibility</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Dashboards Built
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"route":"/engineering/audit","sum":"Yes","act":"Yes (Export)","ev":"Yes","status":"Passed","trace":"EXE-EV-701"},{"route":"/engineering/design","sum":"Yes","act":"Yes (Consistency Score)","ev":"Yes","status":"Passed","trace":"EXE-EV-702"},{"route":"/experience","sum":"Yes","act":"Yes","ev":"Yes","status":"Passed","trace":"EXE-EV-703"}].map((row, i) => (
