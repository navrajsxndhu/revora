      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Dopamine & Feedback Engine
            </h1>
            <p className="text-slate-400">Constitutional governance for positive user reinforcement and completion feedback.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">All actions confirmed</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Generated this week</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Generic Responses
            ...
            <div className="text-xs text-slate-500">No "Saved" messages</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Confidence Score
            ...
            <div className="text-xs text-slate-500">User certainty metric</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"ctx":"Save Policy","prev":"Saved.","rxos":"✓ Policy Verified & Enterprise Synchronized","impact":"+45%","status":"Compliant","trace":"FDB-EV-301"},{"ctx":"User Access","prev":"Success","rxos":"✓ Access Granted & Evidence Recorded","impact":"+38%","status":"Compliant","trace":"FDB-EV-302"},{"ctx":"Delete Record","prev":"Deleted","rxos":"✓ Record securely archived in Ledger","impact":"+62%","status":"Compliant","trace":"FDB-EV-303"}].map((row, i) => (
