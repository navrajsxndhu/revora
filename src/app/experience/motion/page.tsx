      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              <Move className="w-8 h-8 text-cyan-500" />
              Motion Experience Governance
            </h1>
            <p className="text-slate-400">Enterprise governance for motion to communicate system state rather than decorate.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">State-driven animation</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Zero wasted motion</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Loading State
            ...
            <div className="text-3xl font-bold text-white mb-2">Skeleton</div>
            <div className="text-xs text-slate-500">Reduced perceived wait time</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Reduced Motion
            ...
            <div className="text-3xl font-bold text-white mb-2">Enabled</div>
            <div className="text-xs text-slate-500">A11Y compliance</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"type":"Page Transition","purp":"Spatial context","pol":"Opacity fade 200ms","perf":"60fps","status":"Passed","trace":"MOT-EV-401"},{"type":"Data Loading","purp":"State awareness","pol":"Shimmer skeleton","perf":"60fps","status":"Passed","trace":"MOT-EV-402"},{"type":"Success State","purp":"Action confirmation","pol":"Scale-in checkmark 150ms","perf":"60fps","status":"Passed","trace":"MOT-EV-403"}].map((row, i) => (
