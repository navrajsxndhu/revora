      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <p className="text-slate-400">Ensures every screen communicates in plain, executive-friendly language.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-xs text-cyan-400">Plain language compliance</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Requires translation</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Reading Level
            ...
            <div className="text-3xl font-bold text-white mb-2">Grade 8</div>
            <div className="text-xs text-slate-500">Accessible to all roles</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Action Clarity
            ...
            <div className="text-xs text-slate-500">Clear button labels</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"ctx":"Error State","tech":"RuntimeExecution Failed: SigKill","rxos":"Deployment stopped: Governance approval is pending.","rdx":"Low","status":"Compliant","trace":"LNG-EV-501"},{"ctx":"Empty State","tech":"Empty ResultSet (0 rows)","rxos":"No records found matching your filters.","rdx":"Low","status":"Compliant","trace":"LNG-EV-502"},{"ctx":"Server Error","tech":"503 Service Unavailable","rxos":"System is temporarily offline for maintenance.","rdx":"Low","status":"Compliant","trace":"LNG-EV-503"}].map((row, i) => (
