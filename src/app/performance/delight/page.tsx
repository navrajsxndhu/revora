      ...
      <div className="max-w-7xl mx-auto space-y-8 flex flex-col h-[calc(100vh-4rem)]">
        ...
        <header className="flex items-end justify-between border-b border-slate-900 pb-6 shrink-0">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-2 flex items-center gap-3">
              ...
              Delight & Micro-Interaction Engine
            </h1>
            <p className="text-slate-400">Creating memorable, premium enterprise interactions that reduce software fatigue.</p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 shrink-0">
          ...
          <div className="bg-slate-900/60 border border-cyan-900/30 bg-cyan-950/10 shadow-[0_0_15px_rgba(6,182,212,0.05)] rounded-xl p-5">
            ...
            <div className="text-3xl font-bold text-white mb-2">96/100</div>
            <div className="text-xs text-cyan-400">User experience index</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Governed subtle effects</div>
          </div>
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            <div className="text-slate-400 text-sm font-medium mb-1 flex items-center justify-between">
              Cognitive Easing
          ...
          <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5">
            ...
            <div className="text-xs text-slate-500">Motion is purposeful</div>
          </div>
        </div>
        ...
        <div className="flex-1 min-h-0 pb-12 flex flex-col gap-6">
          ...
          >
            {[{"int":"Form Success","trig":"Submit Complete","resp":"Checkmark Draw + Glow","hap":"Light Tap","gov":"Approved","trace":"DME-EV-701"},{"int":"Delete Warning","trig":"Destructive Hover","resp":"Subtle Pulse (Red)","hap":"None","gov":"Approved","trace":"DME-EV-702"},{"int":"Navigation Switch","trig":"Tab Change","resp":"Sliding Underline Indicator","hap":"None","gov":"Approved","trace":"DME-EV-703"}].map((row, i) => (
