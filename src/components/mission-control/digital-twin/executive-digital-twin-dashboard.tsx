...
export function ExecutiveDigitalTwinDashboard() {
  return (
    <div className="bg-gradient-to-br from-slate-900 to-indigo-950/20 border border-slate-800 rounded p-6">
      <div className="flex justify-between items-start mb-6 border-b border-slate-800 pb-4">
        <div>
          <h2 className="text-lg font-bold text-slate-100 flex items-center font-sans">
            <Copy className="w-5 h-5 mr-2 text-indigo-400" />
            Enterprise Digital Twin Command
          </h2>
          <p className="text-[10px] font-mono text-slate-400 mt-1 uppercase tracking-wider">Operational Simulator & Replay Engine</p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        <div className="bg-slate-950/80 border border-slate-800/80 rounded p-4 relative overflow-hidden">
          <div className="text-[10px] font-mono text-slate-500 mb-2">VALIDATION SUCCESS</div>
          ...
          <div className="text-[10px] text-emerald-500 flex items-center font-mono">
            <ShieldCheck className="w-3 h-3 mr-1" /> All rules passed
          </div>
        </div>

        <div className="bg-slate-950/80 border border-slate-800/80 rounded p-4">
          <div className="text-[10px] font-mono text-slate-500 mb-2">SIMULATION COVERAGE</div>
        ...
        <div className="bg-slate-950/80 border border-slate-800/80 rounded p-4">
          <div className="text-[10px] font-mono text-slate-500 mb-2">REPLAY COVERAGE</div>
        ...
        <div className="bg-slate-950/80 border border-slate-800/80 rounded p-4">
          <div className="text-[10px] font-mono text-slate-500 mb-2">STATE DRIFT</div>
          <div className="text-2xl font-bold text-emerald-400 mb-1 font-mono">0.00%</div>
          <div className="text-[10px] text-emerald-500 flex items-center font-mono">
            Zero variance
          </div>
        </div>
        ...
        <div className="bg-slate-950/80 border border-slate-800/80 rounded p-4 relative overflow-hidden">
          <div className="text-[10px] font-mono text-slate-500 mb-2">INTEGRITY INDEX</div>
