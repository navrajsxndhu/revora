...
interface OptimizationImprovementTimelineProps {
  timelineData: number[]; // Array of past scores
}

export function OptimizationImprovementTimeline({ timelineData }: OptimizationImprovementTimelineProps) {
