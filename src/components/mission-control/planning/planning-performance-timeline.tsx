...
interface PlanningPerformanceTimelineProps {
  timelineData: number[];
}

export function PlanningPerformanceTimeline({ timelineData }: PlanningPerformanceTimelineProps) {
