...
interface OperationalAssuranceFeedProps {
  logs: string[];
}

export function OperationalAssuranceFeed({ logs }: OperationalAssuranceFeedProps) {
  return (
      ...
      <CardContent>
        {logs && logs.length > 0 ? (
          ...
          <div className="text-sm text-slate-500 italic mt-4">
            Awaiting verification initialization.
          </div>
        )}
      </CardContent>
    </Card>
