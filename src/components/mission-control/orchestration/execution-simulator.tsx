...
export function ExecutionSimulator() {
  ...
  return (
    <div className="bg-slate-900 border border-slate-800 h-full flex flex-col items-center justify-center p-6 text-center">
      <div className="mb-4">
        <div className="text-sm font-bold text-slate-200 uppercase font-sans mb-1">Execution Simulator</div>
        <div className="text-[10px] font-mono text-slate-500">DRY RUN KERNEL</div>
      </div>
      <select className="bg-slate-950 border border-slate-800 text-xs font-mono text-slate-300 p-2 rounded w-full max-w-sm mb-4">
        <option>WORKFLOW: Mass Deployment 2.0</option>
        <option>WORKFLOW: Cloud Region Failover</option>
      </select>
      <button 
